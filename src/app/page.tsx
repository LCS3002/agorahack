    ...
    >
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          <div style={{ fontSize: 10, fontWeight: 500, color: 'rgba(26,26,24,0.35)', letterSpacing: '3px', textTransform: 'uppercase', marginBottom: 48 }}>
            Built at AgoraHacks 2026
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 32 }}>
            {([
              ...
              },
              {
                ...
                study: 'Wirtschaftsingenieurwesen Maschinenbau',
                at: 'TU Vienna',
                github: null,
              ...
              <div key={p.name} style={{ borderTop: '1px solid rgba(26,26,24,0.12)', paddingTop: 20 }}>
                <div style={{ fontSize: 14, fontWeight: 400, color: '#1A1A18', marginBottom: 4 }}>{p.name}</div>
                <div style={{ fontSize: 11, fontWeight: 300, color: 'rgba(26,26,24,0.55)', lineHeight: 1.5, marginBottom: 16 }}>
                  {p.study}<br />{p.at}
                </div>
                <div style={{ display: 'flex', gap: 12 }}>
                  <a href={p.linkedin} target="_blank" rel="noopener noreferrer" title="LinkedIn" style={{ color: 'rgba(26,26,24,0.35)', transition: 'color 0.15s ease', display: 'flex', alignItems: 'center' }}
                    onMouseEnter={e => { (e.currentTarget as HTMLElement).style.color = '#1A1A18'; }}
                  ...
                  {p.github && (
                    <a href={p.github} target="_blank" rel="noopener noreferrer" title="GitHub" style={{ color: 'rgba(26,26,24,0.35)', transition: 'color 0.15s ease', display: 'flex', alignItems: 'center' }}
                      onMouseEnter={e => { (e.currentTarget as HTMLElement).style.color = '#1A1A18'; }}
                      onMouseLeave={e => { (e.currentTarget as HTMLElement).style.color = 'rgba(26,26,24,0.35)'; }}>
                      {/* GitHub icon */}
                      <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
